...
function sanitize(id: string, value: Record<string, unknown>): Box {
  return {
    ...
    photoPath:
      typeof value.photoPath === "string" ? value.photoPath : undefined,
    items: Array.isArray(value.items) ? (value.items as Box["items"]) : [],
    manualDescription:
      typeof value.manualDescription === "string"
        ? value.manualDescription
        : undefined,
    aiGeneratedTags: Array.isArray(value.aiGeneratedTags)
      ? value.aiGeneratedTags.filter(
          (tag): tag is string => typeof tag === "string",
        )
      : [],
    suggestedRoom:
      typeof value.suggestedRoom === "string" ? value.suggestedRoom : undefined,
    assignedRoom:
      typeof value.assignedRoom === "string" ? value.assignedRoom : undefined,
