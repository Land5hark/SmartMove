...
function getApiKey() {
  return process.env.GEMINI_API_KEY || process.env.GOOGLE_API_KEY || process.env.GOOGLE_GENKIT_API_KEY;
}
...
export async function generateGeminiJson<T>({ prompt, photoDataUri }: GeminiJsonRequest): Promise<T> {
